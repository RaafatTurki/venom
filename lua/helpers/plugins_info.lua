local M = {
  ...
  -- astrisk                     = { url = "haya14busa/vim-asterisk" },
  autocomplete                = { url = "deathbeam/autocomplete.nvim" },
  -- snippets                    = { url = "garymjr/nvim-snippets" },
  -- friendly_snippets           = { url = "rafamadriz/friendly-snippets" },
  ...
  -- termim                      = { url = "2KAbhishek/termim.nvim" },
  -- orchestra                   = { url = "timeyyy/orchestra.nvim" },
  ...
  -- sixelview                   = { url = "kjuq/sixelview.nvim" },
