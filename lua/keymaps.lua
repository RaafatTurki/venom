...
map("n", 'd<Left>',           function() vim.diagnostic.jump({ count = -1 }) end, "Go To Previous Diagnostic")
map("n", 'd<Right>',          function() vim.diagnostic.jump({ count = 1 }) end, "Go To Next Diagnostic")
